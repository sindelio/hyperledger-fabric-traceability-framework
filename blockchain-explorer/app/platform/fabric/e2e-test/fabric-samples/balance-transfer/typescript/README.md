...
- [Running the sample program](#running-the-sample-program)
  ...
  - [Option 2 is a more manual approach](#option-2-is-a-more-manual-approach)
      - [Terminal Window 1](#terminal-window-1-1)
      - [Terminal Window 2](#terminal-window-2-1)
      - [Terminal Window 3](#terminal-window-3)
- [Sample REST APIs Requests](#sample-rest-apis-requests)
  - [Login Request](#login-request)
  - [Create Channel request](#create-channel-request)
  - [Join Channel request](#join-channel-request)
  - [Install chaincode](#install-chaincode)
  - [Instantiate chaincode](#instantiate-chaincode)
  - [Invoke request](#invoke-request)
  - [Chaincode Query](#chaincode-query)
  - [Query Block by BlockNumber](#query-block-by-blocknumber)
  - [Query Transaction by TransactionID](#query-transaction-by-transactionid)
  - [Query ChainInfo](#query-chaininfo)
  - [Query Installed chaincodes](#query-installed-chaincodes)
  - [Query Instantiated chaincodes](#query-instantiated-chaincodes)
  ...
  - [Network configuration considerations](#network-configuration-considerations)
    ...
    - [Discover IP Address](#discover-ip-address)
